    ...
    subcategories: [
      {
        ...
        name: "Artikeller ve Haller",
        lessons: [
          { id: "belirli-artikeller", title: "Belirli Artikeller (Der, Die, Das)", content: "Almancada her ismin bir \"doğal cinsiyet\"i vardır ve bu cinsiyet ismin önündeki belirli artikel (der, die, das) ile gösterilir.\nBu sistem Türkçede hiç yoktur; bu yüzden ismi ezberlerken artikelini de birlikte öğrenmek en doğru yoldur.\n* Der (eril): der Mann (erkek), der Tisch (masa), der Bahnhof (istasyon)\n* Die (dişil): die Frau (kadın), die Schule (okul), die Straße (sokak)\n* Das (nötr): das Kind (çocuk), das Buch (kitap), das Auto (araba)\nÇoğul: İsimler çoğula geldiğinde, artikelleri ne olursa olsun hepsi \"die\" artikelini alır.\n* der Mann → die Männer, die Frau → die Frauen, das Kind → die Kinder\nPüf noktaları:\n* \"-ung\", \"-heit\", \"-keit\", \"-tion\" gibi soneklerle biten isimler genellikle die artikelini alır.\n* \"-chen\" ve \"-lein\" ile biten küçültme ekleri her zaman das artikelini alır.\n* Eril kişi isimleri (Vater, Sohn) ve hafta günleri genellikle der artikelini alır." },
          { id: "belirsiz-artikeller", title: "Belirsiz Artikeller (Ein, Eine)", content: "Almancada \"belirsiz artikeller\" (Unbestimmte Artikel), Türkçedeki \"bir\" kelimesine karşılık gelir ve isimden ilk kez bahsedildiğinde ya da genel bir şeyden söz edildiğinde kullanılır.\nBelirsiz artikeller ismin cinsiyetine göre şekil değiştirir:\n* Eril (der → ein): ein Mann (bir erkek), ein Tisch (bir masa)\n* Dişil (die → eine): eine Frau (bir kadın), eine Schule (bir okul)\n* Nötr (das → ein): ein Kind (bir çocuk), ein Buch (bir kitap)\nÖnemli not: Belirsiz artikelin çoğul formu yoktur. Çoğulda artikel kullanılmaz:\n* Ich sehe eine Frau. (Bir kadın görüyorum.) → Ich sehe Frauen. (Kadınlar görüyorum.)\nBelirsiz artikeller, Akkusativ (i-hali) durumunda eril isimler için \"einen\" şekline dönüşür:\n* Ich kaufe einen Apfel. (Bir elma satın alıyorum.)\n* Ich kaufe eine Banane. (Bir muz satın alıyorum.)\n* Ich kaufe ein Brot. (Bir ekmek satın alıyorum.)" },
          { id: "olumsuz-artikeller", title: "Olumsuz Artikeller (Kein, Keine)", content: "Almancada \"olumsuz artikeller\" (Negativartikel) kein/keine/kein, bir şeyin olmadığını veya reddini ifade eder. Belirsiz artikeller (ein/eine/ein) ile hemen hemen aynı çekime sahiptir; sadece başına \"k-\" eklenir.\n* Eril (ein → kein): Ich habe keinen Bruder. (Kardeşim yok.)\n* Dişil (eine → keine): Ich habe keine Schwester. (Kız kardeşim yok.)\n* Nötr (ein → kein): Ich habe kein Auto. (Arabam yok.)\n* Çoğul: Ich habe keine Geschwister. (Kardeşim/kardeşlerim yok.)\nNicht ile kein arasındaki fark:\n* kein: İsimlerin (özellikle belirsiz veya sayılabilir isimlerin) önünde olumsuzluk yapar.\n* nicht: Fiilleri, sıfatları veya belirli artikelli isimleri olumsuzlar.\n* Ich kaufe kein Brot. (Ekmek almıyorum.) — kein, çünkü belirsiz isim\n* Ich kaufe das Brot nicht. (Şu ekmeği almıyorum.) — nicht, çünkü belirli isim" },
          { id: "akkusativ", title: "Akkusativ (İ-Hali)",
            content: "Almancada \"Akkusativ\" (İ-hali / -i durumu), cümlede doğrudan etkilenen nesneyi (\"neyi/kimi?\") gösterir. Türkçedeki \"-i, -ı, -u, -ü\" ekine benzer bir işlev görür.\nAkkusativ'de esas değişim erkek (eril) isimlerin artikelinde gerçekleşir:\n* der → den: Ich sehe den Mann. (Adamı görüyorum.)\n* die → die (değişmez): Ich sehe die Frau. (Kadını görüyorum.)\n* das → das (değişmez): Ich sehe das Kind. (Çocuğu görüyorum.)\nBelirsiz artikel:\n* ein → einen (sadece eril değişir): Ich kaufe einen Apfel.\n* eine → eine (değişmez): Ich kaufe eine Banane.\nOlumsuz artikel:\n* kein → keinen (sadece eril değişir): Ich habe keinen Bruder.\nŞahıs zamirleri Akkusativ'de: ich → mich, du → dich, er → ihn, sie/es/wir → sie/es/uns, ihr → euch, sie/Sie → sie/Sie\n* Ich liebe dich. (Seni seviyorum.)" },
          { id: "dativ", title: "Dativ (E-Hali)", content: "Almancada \"Dativ\" (E-hali), cümlede dolaylı nesneyi — yani eylemin kime veya neye yönelik olduğunu — gösterir. Türkçedeki \"-e, -a\" ekine benzer işlev görür.\nDativ'de tüm artikeller değişime uğrar:\n* der (eril) → dem: Ich gebe dem Mann das Buch. (Adama kitabı veriyorum.)\n* die (dişil) → der: Ich gebe der Frau das Buch.\n* das (nötr) → dem: Ich gebe dem Kind das Buch.\n* die (çoğul) → den (+ çoğul isim sonuna genellikle -n eklenir): Ich gebe den Kindern das Buch.\nBelirsiz artikel Dativ'de:\n* ein → einem (eril/nötr), eine → einer (dişil)\nDativ alan edatlar: mit (ile), bei (yanında), nach (sonra/göre), von (dan/den), zu (e doğru), aus (dan/den), seit (beri), gegenüber (karşısında)\n* Ich fahre mit dem Bus. (Otobüsle gidiyorum.)\n* Er wohnt bei seiner Mutter. (Annesinin yanında oturuyor.)" },
        ]
      }
    ]
  },
      ...
      },
      {
        ...
        lessons: [
          ...
          },
          {
            id: "denn",
            title: "Denn (Çünkü)",
            content: "Almancada hem \"weil\" hem de \"denn\" bağlaçları \"çünkü\" anlamına gelir. Ancak cümle kurma bakımından birbirinden tamamen farklı davranırlar.\nWeil → Fiili Sona Atar (Yan Cümle):\n\"Weil\" bağlacıyla fiil mecburen cümlenin en sonuna gider.\n* Ich bleibe zu Hause, weil ich krank bin.\n* (Evde kalıyorum, çünkü hasta[yım] — fiil sona gitti)\nDenn → Fiil Sona GİTMEZ (Ana Cümle):\n\"Denn\" ise bulunduğu cümlede kelime sırasını değiştirmez. Fiil her zamanki gibi 2. sırasında kalır.\n* Ich bleibe zu Hause, denn ich bin krank.\n* (Evde kalıyorum, çünkü ben hastayım — fiil normal 2. sırada)\nHangisini ne zaman kullanmalı?\n* Denn: iki cümleyi bağlayan bir virgülden sonra kullanılır. Günlük konuşmada yaygındır.\n* Weil: nedeni vurgulamak istendiğinde veya neden ifadesini cümle başına almak gerektiğinde kullanılır.\nÖnemli: Denn tek başına cümle başlatamaz; her zaman bir ana cümlenin arkasından, virgülle gelir."
          },
        ]
      },
      {
        ...
        lessons: [
          { id: "indirekte-fragen", title: "Dolaylı Sorular (Indirekte Fragen)", content: "Almancada \"Dolaylı Sorular\" (Indirekte Fragen), bir soruyu doğrudan sormak yerine başka bir cümlenin içine gömerek daha kibar bir şekilde ifade etmemizi sağlar.\nDoğrudan soru: Wo ist der Bahnhof? (İstasyon nerede?)\nDolaylı soru: Können Sie mir sagen, wo der Bahnhof ist? (İstasyonun nerede olduğunu söyleyebilir misiniz?)\nKural: Dolaylı sorularda fiil her zaman cümlenin en sonuna gider — tıpkı weil/dass gibi!\nW-Sorularla Dolaylı Soru:\nSoru kelimesi (wo, wann, wie, warum vb.) bağlaç görevi görür:\n* Ich weiß nicht, wo er wohnt. (Nerede oturduğunu bilmiyorum.)\n* Er fragt, wann der Zug kommt. (Trenin ne zaman geleceğini soruyor.)\nEvet/Hayır Sorularından Dolaylı Soru:\nDirekt evet/hayır sorularında \"ob\" bağlacı kullanılır:\n* Kommt er? → Ich weiß nicht, ob er kommt. (Gelip gelmediğini bilmiyorum.)\nSık Kullanılan Kalıplar:\n* Können Sie mir sagen, ...? (Bana söyleyebilir misiniz, ...?)\n* Ich möchte wissen, ... (Bilmek istiyorum, ...)\n* Weißt du, ...? (Biliyor musun, ...?)" },
        ]
      }
    ]
  },
    ...
    subcategories: [
      {
        ...
        name: "Zamirler",
        lessons: [
          { id: "sahis-zamirleri", title: "Şahıs Zamirleri (Nominativ, Akkusativ, Dativ)", content: "Almancada şahıs zamirleri (Personalpronomen), tıpkı artikellerde olduğu gibi, ismin hangi halde (Nominativ, Akkusativ, Dativ) kullanıldığına göre kılık değiştirir.\n1. Nominativ (Yalın Hal - İşi yapan):\nIch (ben), du (sen), er/sie/es (o), wir (biz), ihr (siz), sie/Sie (onlar/Siz)\n2. Akkusativ (-i Hali) Püf Noktası:\n\"Beni, seni, onu\" anlamlarını verir. Dikkat edilecek ses: \"-ch\" sesi!\n* ich → mich (beni), du → dich (seni)\n* er → ihn (onu - eril), sie/es → sie/es (onu - dişil/nötr)\n* wir → uns (bizi), ihr → euch (sizi)\n3. Dativ (-e Hali) Püf Noktası:\n\"Bana, sana, ona\" anlamlarını verir. Dikkat edilecek ses: \"-r\" ve \"-m\" sesleri!\n* ich → mir (bana), du → dir (sana)\n* er/es → ihm (ona), sie → ihr (ona - dişil)\n* wir → uns (bize), ihr → euch (size), sie/Sie → ihnen/Ihnen (onlara/Size)\nÖrnek: Ich liebe dich. (Seni seviyorum.) — Akkusativ\nÖrnek: Er gibt mir das Buch. (O bana kitabı veriyor.) — Dativ" },
          { id: "iyelik-zamirleri", title: "İyelik Zamirleri (Possessivartikel)", content: "Almancada \"İyelik Zamirleri\" (Possessivartikel), \"benim, senin, onun\" gibi kime ait olduğunu belirtmemizi sağlar. Şahıslara göre iyelik kökleri:\n* ich → mein (benim), du → dein (senin)\n* er/es → sein (onun - eril/nötr), sie → ihr (onun - dişil)\n* wir → unser (bizim), ihr → euer (sizin), sie/Sie → ihr/Ihr (onların/Sizin)\nEn Büyük Püf Noktası: Ek, sahip olana değil, sahip olunan nesnenin artikeline göre eklenir!\n* Nesne der veya das ise: iyelik kökü ek almaz → mein Vater (benim babam), mein Auto (benim arabam)\n* Nesne die (dişil) veya çoğulsa: kökün sonuna \"-e\" eklenir → meine Mutter (benim annem), meine Bücher (benim kitaplarım)\n* Akkusativ'de eril isim: sonuna \"-en\" eklenir → Ich liebe meinen Vater.\n* \"Euer\" istisnası: die veya çoğul önünde \"euere\" yerine \"eure\" kullanılır (ortadaki \"e\" düşer).\nÖrnekler:\n* Das ist mein Bruder. (Bu benim erkek kardeşim.) — der Bruder → mein\n* Wo ist deine Tasche? (Çantan nerede?) — die Tasche → deine" },
        ]
      },
      {
        id: "sifatlar",
        name: "Sıfatlar",
        lessons: [
          { id: "sifat-cekimi", title: "Sıfat Çekimi (Adjektivdeklination)", content: "Almancada sıfatlar iki farklı şekilde kullanılır:\n1. İsmin arkasında (yüklem sıfatı): Hiçbir ek almaz.\n* Der Tisch ist groß. (Masa büyük.)\n2. İsmin önünde (tamlayan sıfatı): Cümlenin hali ve artikeline göre ek alır.\nTemel kural: Önündeki artiklere ve haline göre \"-e\", \"-en\", \"-er\", \"-es\" gibi ekler alır.\nBelirli artikel (der/die/das) sonrası:\n* Nominativ: der alte Mann, die alte Frau, das alte Kind\n* Akkusativ: den alten Mann, die alte Frau, das alte Kind\nBelirsiz artikel (ein/eine/ein) sonrası:\n* Nominativ: ein alter Mann, eine alte Frau, ein altes Kind\n* Akkusativ: einen alten Mann, eine alte Frau, ein altes Kind\nPratik hatırlama: Belirli artikel kullanıldığında sıfatlar çoğunlukla \"-e\" veya \"-en\" alır. Belirsiz artikel kullanıldığında sıfat bir miktar artikelin görevini üstlenir (\"-er\", \"-es\" gibi güçlü ekler alabilir)." },
          { id: "derecelendirme", title: "Derecelendirme (Komparativ & Superlativ)", content: "Almancada sıfatlar 3 basamaklı bir derecelendirme sistemine sahiptir:\n1. Positiv (Eşitlik - so ... wie):\nİki nesne eşitse, sıfatı yalın haliyle kullanırsın.\n* Ich bin so müde wie du. (Senin kadar yorgunum.)\n2. Komparativ (Kıyaslama - -er + als):\nBiri diğerinden \"daha\" üstünse, sıfata \"-er\" eklenir, karşılaştırma için \"als\" kullanılır.\n* Ich bin müder als du. (Senden daha yorgunum.)\n3. Superlativ (En üstünlük - am ...-sten):\n\"En\" anlamını katmak için başa \"am\", sona \"-sten\" (veya \"-esten\") eklenir.\n* Ich bin am müdesten. (En yorgun benim.)\nPüf noktaları:\n* a, o, u içeren bazı sıfatlar Umlaut alır: kurz → kürzer, jung → jünger\n* Düzensiz derecelendirmeler: gut → besser → am besten (iyi - daha iyi - en iyi)\n* gern → lieber → am liebsten (seve seve - tercihen - en çok severek)\n* viel → mehr → am meisten (çok - daha çok - en çok)" },
        ]
      }
    ]
  },
    ...
    subcategories: [
      {
        ...
        name: "Temel İletişim",
        lessons: [
          { id: "selamlasma-vedalasma", title: "Selamlaşma ve Vedalaşma", content: "Almancada selamlaşma ve vedalaşma kalıpları, günün saatine ve iletişimin yüz yüze olup olmamasına göre değişir.\nSelamlaşma (Begrüßung):\n* Hallo: Günün her saatinde kullanılabilen \"Merhaba\".\n* Guten Morgen: Sabah 6-9 arası \"Günaydın\".\n* Guten Tag: Saat 10'dan 16-17'ye kadar \"İyi günler\".\n* Guten Abend: Saat 17-20 arası \"İyi akşamlar\".\nVedalaşma (Verabschiedung):\n* Auf Wiedersehen: Yüz yüze iletişimde \"Görüşmek üzere\" (\"Auf Wiederhören\" telefonda kullanılır, çünkü \"hören\" = duymak).\n* Tschüss: Günlük hayatta en yaygın kullanılan \"Hoşça kal\".\n* Bis bald: \"Yakında görüşürüz\".\n* Gute Nacht: Saat 20:00'den sonra \"İyi geceler\". Dikkat: \"Guten\" değil \"Gute\" denir — \"die Nacht\" (dişil) yüzünden Akkusativ'de \"-e\" eki alır." },
          { id: "kendini-tanitma", title: "Kendini Tanıtma", content: "Almancada kendini tanıtmak (Sich vorstellen) için üç temel kalıp kullanılır:\n1. İsim Sorma ve Söyleme:\n* Wie heißt du? / Ich heiße Erhan. (Adın ne? / Adım Erhan.)\n* Wie ist dein Name? / Mein Name ist Özdemir. (Resmi durumda soyisim için)\n* Wer bist du? / Ich bin Erhan. (Sen kimsin? / Ben Erhan'ım.)\n2. Memleket ve Yaşanılan Yer:\n\"Nereden?\" sorusunda (Woher kommst du?) → \"aus\" edatı kullanılır:\n* Ich komme aus der Türkei. (Türkiye'den geliyorum.)\n\"Nerede yaşıyorsun?\" (Wo wohnst du?) → \"in\" edatı kullanılır:\n* Ich wohne in Istanbul. (İstanbul'da oturuyorum.)\n3. Yaş Söyleme:\n* Wie alt bist du? → Ich bin zwanzig Jahre alt. (20 yaşındayım.)\nKısaca: \"Ich bin\" kalıbı ile isim, yaş veya meslek belirtebilirsin. Meslek belirtirken artikel kullanılmaz:\n* Ich bin Lehrer. (Ben öğretmenim.) — \"ein Lehrer\" değil!" },
          { id: "nasilsin", title: "Nasılsın? (Wie geht's?)", content: "Almancada \"Nasılsın?\" sorusu Wie geht es dir? veya kısaca Wie geht's? şeklinde sorulur. Resmi ortamda ise Wie geht es Ihnen? (Siz nasılsınız?) kullanılır.\nCevap kalıpları ve dereceleri:\n* Müthiş: Es geht mir super / wunderbar / spitze! (Harika!)\n* Çok iyi: Es geht mir sehr gut. (Çok iyiyim.)\n* İyi: Es geht mir gut. (İyiyim.)\n* İdare eder: Na ja, es geht. (Eh işte, şöyle böyle.)\n* İyi değil: Es geht mir nicht so gut. (O kadar iyi değilim.)\n* Kötü: Es geht mir schlecht. (Kötüyüm.)\n* Berbat: Es geht mir furchtbar. (Berbat hissediyorum.)\nÖnemli püf nokta: Bu kalıplar Türkçeye birebir \"bana iyi gidiyor\" değil, \"iyi hissediyorum\" / \"kötü hissediyorum\" şeklinde çevrilir. \"Mir\" = bana (Dativ zamiri)." },
          { id: "yol-tarifi", title: "Yol Tarifi (Wegbeschreibung)", content: "Almancada yol sormak için önce \"Entschuldigung\" (Afedersiniz) diyerek başlarsın. Genellikle resmi \"Sie\" (Siz) formu kullanılır.\nYol sorma:\n* Entschuldigung, wie komme ich zum Bahnhof? (Afedersiniz, istasyona nasıl gidebilirim?)\nYönlendirme kalıpları:\n* Düz git: Gehen Sie geradeaus. (Dümdüz gidin.)\n* Sola/sağa sapın: Biegen Sie links/rechts ab. (ayrılabilir fiil: abbiegen)\n* İkinci sokakta: Nehmen Sie die zweite Straße rechts.\n* Trafik ışıklarına kadar: Gehen Sie bis zur Ampel.\n* Kavşağa kadar: bis zur Kreuzung\nGeçme/Dolaşma kalıpları:\n* Köprünün üstünden: Gehen Sie über die Brücke.\n* İçinden: Gehen Sie durch das Stadttor.\n* Yanından geçin (girmeden): Gehen Sie an der Schule vorbei.\nBitiriş: Dort ist der Bahnhof. (İstasyon orada.)" },
        ]
      },
      {
        id: "zaman-ve-sayilar",
        ...
        lessons: [
          { id: "sayilar-siralama", title: "Sayılar ve Sıralama Sayıları", content: "Almancada sayılar kendi içinde pratik bir mantığa sahiptir.\n1. En Büyük Püf Noktası: Tersten Okuma (21 ve Sonrası)\n20'den büyük sayılarda önce birler, sonra onlar basamağı söylenir, araya \"und\" konur:\n* 24 = vierundzwanzig (dört-ve-yirmi)\n* 35 = fünfunddreißig — bu sayılar bitişik yazılır!\n2. Dikkat Gerektiren Sayılar:\n* 16: sechzehn (\"s\" düşer)\n* 17: siebzehn (\"en\" düşer)\n* 30: dreißig (\"-ßig\" ile biter, diğerleri \"-zig\")\n3. Yılları Okuma:\n2000 öncesi yıllar ikiye bölünür, araya \"hundert\" konur:\n* 1987 = neunzehnhundertsiebenundachtzig (19 yüz 87)\n* 2002 = zweitausendzwei (normal okunuş)\n4. Sıralama Sayıları (1., 2., 3.):\n* 1–19 arası: sayı + \"-te\" → erste (1.), zweite (2.), dritte (3.), achte (8.)\n* 20 ve sonrası: sayı + \"-ste\" → zwanzigste, einundzwanzigste\n5. Tarih Söyleme:\n\"Am\" edatıyla tarih belirtildiğinde sıralama sayısına \"-n\" eklenir:\n* am dritten Mai (3 Mayıs'ta) — \"dritte\" → \"dritten\"" },
          { id: "saat-sorma", title: "Saat Sorma ve Söyleme", content: "Almancada iki farklı saat sistemi kullanılır: Resmi (24 saatlik) ve Günlük (12 saatlik).\nSaat Sormak:\n* Wie spät ist es? (Ne kadar geç?) / Wie viel Uhr ist es? (Saat kaç?)\nCevap verirken hep \"Es ist...\" ile başlanır.\n1. Tam Saatler:\n* Es ist neun Uhr. (Saat 9:00)\n* Resmi: Es ist siebzehn Uhr. (17:00) / Günlük: Es ist fünf Uhr. (5)\n2. Geçiyor (Nach) ve Var (Vor):\nGünlük dilde: önce dakika, sonra durum (nach/vor), sonra saat:\n* 19:10 → zehn nach sieben (7'yi 10 geçiyor)\n* 22:50 → zehn vor elf (11'e 10 var)\n3. Çeyrekler (Viertel):\n* 09:15 → Viertel nach neun (9'u çeyrek geçiyor)\n* 09:45 → Viertel vor zehn (10'a çeyrek var)\n4. En Büyük Tuzak — Buçuklar (Halb):\nAlmanlar bir sonraki saate göre söyler!\n* 11:30 → halb zwölf (12'nin yarısı = 11:30) — Türkçedeki gibi \"halb elf\" DEĞİL!" },
          { id: "gunler-aylar-mevsimler", title: "Günler, Aylar ve Mevsimler", content: "Almancada günler ve aylar belirtilirken doğru edatı seçmek çok önemlidir.\nGünler (Die Tage) — \"am\" edatıyla:\nMontag (Pazartesi), Dienstag (Salı), Mittwoch (Çarşamba), Donnerstag (Perşembe), Freitag (Cuma), Samstag (Cumartesi), Sonntag (Pazar)\n* am Montag (Pazartesi günü), am Freitag (Cuma günü)\nAylar (Die Monate) — \"im\" edatıyla:\nJanuar (Ocak), Februar (Şubat), März (Mart), April (Nisan), Mai (Mayıs), Juni (Haziran), Juli (Temmuz), August (Ağustos), September (Eylül), Oktober (Ekim), November (Kasım), Dezember (Aralık)\n* im Januar (Ocak ayında), im Sommer (yazın)\nMevsimler (Die Jahreszeiten) — \"im\" edatıyla:\nFrühling (ilkbahar), Sommer (yaz), Herbst (sonbahar), Winter (kış)\nÖnemli kural: Almancada ayların baş harfi cümlede nerede olursa olsun her zaman büyük yazılır (Januar, März vb.)." },
          { id: "zaman-zarflari", title: "Zaman Zarfları (Morgens, Abends, vb.)", content: "Almancada zaman zarfları, eylemlerin günün hangi diliminde veya ne sıklıkla yapıldığını belirtir. Bu zarflar cümlenin başına veya TeKaMoLo kuralı gereği zamanın belirtileceği pozisyona yerleştirilir.\nGünün Dilimleri:\n* morgens (sabahları), mittags (öğlenleri), abends (akşamları), nachts (geceleri)\n* Am Morgen, Am Mittag, Am Abend, In der Nacht şeklinde de kullanılır.\nSıklık Belirtme:\n* immer (her zaman), oft (sık sık), manchmal (bazen), selten (nadiren), nie (hiçbir zaman)\n* jeden Tag (her gün), jede Woche (her hafta), jeden Monat (her ay)\nGeçmiş - Şimdiki - Gelecek:\n* gestern (dün), heute (bugün), morgen (yarın)\n* vorgestern (önceki gün), übermorgen (öbür gün)\n* letzte Woche (geçen hafta), nächste Woche (gelecek hafta)\nÖrnekler:\n* Ich lerne morgens Deutsch. (Sabahları Almanca öğreniyorum.)\n* Sie geht jeden Tag in den Park. (Her gün parka gidiyor.)" },
        ]
      },
      {
        id: "yasam-ve-cevre",
        name: "Yaşam ve Çevre",
        lessons: [
          { id: "aile-uyeleri", title: "Aile Üyeleri (Die Familie)", content: "Almancada aile üyeleri artikelleriyle öğrenilir. Der (eril) ve die (dişil) artikeller sana güzel bir gruplama ipucu verir.\nTemel Aile Üyeleri:\n* Ebeveynler: der Vater / der Papa (baba), die Mutter / die Mama (anne) → Çoğul: die Eltern\n* Büyük ebeveynler: der Großvater / der Opa (büyükbaba), die Großmutter / die Oma (büyükanne) → die Großeltern\n* Kardeşler: der Bruder (erkek kardeş), die Schwester (kız kardeş) → die Geschwister\n* Çocuklar: der Sohn (oğul), die Tochter (kız evlat) → die Kinder\n* Akrabalar: der Onkel (amca/dayı/enişte), die Tante (teyze/hala/yenge)\n* der Cousin (erkek kuzen), die Cousine (kız kuzen)\nİyelik Zamirleriyle Kullanım:\n\"der\" ve \"das\" artikleli kelimelerle iyelik eki alınmaz: mein Vater, mein Sohn\n\"die\" artikleli veya çoğul kelimelerle \"-e\" eklenir: meine Mutter, meine Geschwister" },
          { id: "meslekler", title: "Meslekler (Die Berufe)", content: "Almancada meslekler cinsiyet bazlı ikiye ayrılır ve bu ayrım sistematik bir kurala dayanır.\n1. Altın Kural — \"-in\" Takısı:\nErkek meslekler \"der\" artikleli ve yalın haliyle kullanılır. Aynı mesleği kadın yapıyorsa kelimenin sonuna \"-in\" eklenir ve artikel \"die\" olur.\n* der Lehrer → die Lehrerin (öğretmen)\n* der Verkäufer → die Verkäuferin (satıcı)\n* der Arzt → die Ärztin (doktor — Umlaut da alır!)\n* der Koch → die Köchin (aşçı — Umlaut alır)\n2. İstisnalar:\n* Hausmann / Hausfrau (ev erkeği / ev hanımı)\n* der Krankenpfleger / die Krankenschwester (hemşire)\n3. Meslek Sorma ve Söyleme:\n* Soru: Was machst du beruflich? / Was ist dein Beruf?\n* Cevap: Ich bin Lehrer. (Öğretmenim.) — artikel KULLANILMAZ\n* veya: Ich arbeite als Lehrerin. (Öğretmen olarak çalışıyorum.)\nİpucu: Meslekte \"ein\" kullanmak Almanca'da yanlıştır. \"Ich bin Arzt\" deriz, \"Ich bin ein Arzt\" değil." },
          { id: "vucut-saglik", title: "Vücut Bölümleri ve Sağlık", content: "Almancada vücut bölümlerini (die Körperteile) artikelleriyle birlikte öğrenmek önemlidir.\nTemel Vücut Bölümleri:\n* Der artikeliyle: der Kopf (baş), der Rücken (sırt), der Bauch (karın), der Hals (boğaz)\n* Die artikeliyle: die Nase (burun), die Hand (el) → çoğul: die Hände\n* Das artikeliyle: das Auge (göz) → çoğul: die Augen, das Ohr (kulak), das Bein (bacak)\nSağlık Durumu Sorma:\n* Was fehlt dir? (Sende ne var / ne eksik?) — samimi\n* Was fehlt Ihnen? — resmi\nAğrıyı İfade Etme:\n1. \"tut weh\" kalıbı — tek organ ağrıyorsa:\n* Mein Kopf tut weh. (Başım ağrıyor.)\n* Çoğul ağrı: Meine Augen tun weh. (Gözlerim acıyor.) — tun (çoğul)\n2. \"Schmerzen\" kalıbı — süregelen ağrılar için:\n* Ich habe Kopfschmerzen. (Baş ağrım var.)\n* Ich habe Bauchschmerzen. (Karın ağrım var.)" },
          { id: "renkler-meyveler-ulkeler", title: "Renkler, Meyveler ve Ülkeler", content: "Almancada temel sözcük grupları olan renkler, meyveler ve ülkeler için bilmen gereken pratik kurallar:\n1. Renkler (Die Farben):\nİsmin arkasından kullanıldığında (yüklem sıfatı) ek almazlar:\n* Der Himmel ist blau. (Gökyüzü mavidir.)\nTemel renkler: rot (kırmızı), blau (mavi), grün (yeşil), gelb (sarı), weiß (beyaz), schwarz (siyah), braun (kahverengi), rosa (pembe)\n2. Meyveler (Das Obst):\nÇok büyük çoğunluğu \"die\" artikelini alır!\n* die Banane, die Orange, die Birne, die Erdbeere, die Zitrone, die Wassermelone\n* İstisnalar: der Apfel (elma), der Pfirsich (şeftali)\n3. Ülkeler (Die Länder):\nÇoğu ülke artikelsiz kullanılır: Deutschland, Italien, Spanien\nArtikel alanlar: die Türkei, die Schweiz, die USA, der Iran, der Irak\nNereden geldiğini söyleme (\"aus\" edatı + Dativ):\n* Ich komme aus Deutschland. (Almanya'dan geliyorum.) — artikelsiz\n* Ich komme aus der Türkei. (Türkiye'den geliyorum.) — \"die\" → \"der\" (Dativ)" },
        ]
      }
    ]
  },
    ...
    subcategories: [
      {
        ...
        name: "Edatlar",
        lessons: [
          { id: "yer-edatlari", title: "Yer Edatları (Lokale Präpositionen)", content: "Almancada yer edatları (Lokale Präpositionen) bir nesnenin veya kişinin konumunu belirtir.\nTemel Yer Edatları:\n* in (içinde), auf (üstünde — temaslı), über (üzerinde — temassız)\n* unter (altında), vor (önünde), hinter (arkasında)\n* neben (yanında), an (bitişiğinde), zwischen (arasında)\nEn Büyük Püf Noktası — \"Nerede\" mi \"Nereye\" mi?\nBu edatlar Dativ veya Akkusativ alır; hangisini aldıkları soruya bağlıdır:\n* Wo? (Nerede? — Sabit Konum) → Dativ alır\n   Das Kind ist auf dem Stuhl. (Çocuk sandalyenin üstünde.)\n* Wohin? (Nereye? — Hareket) → Akkusativ alır\n   Das Kind geht auf den Stuhl. (Çocuk sandalyenin üstüne gidiyor.)\nSadece Dativ Alan Yer Edatları:\n* zu (-e doğru — insanlar ve bazı mekanlar): zum Arzt (doktora)\n* aus (-dan çıkış): aus der Schule (okuldan)\n* von (birinden/bir yerden dönüş): von meiner Mutter (annemden)" },
          { id: "yonelim-edatlari", title: "Yönelim Edatları (In, Zu, An, Nach)", content: "Almancada \"Nereye gidiyorsun?\" (Wohin?) sorusuna cevap verirken hedefin türüne göre farklı edatlar kullanılır.\n1. in + Akkusativ (İçine doğru):\nKapalı bir binanın veya sınırları olan bir yerin içine giriyorsan:\n* ins Museum (müzeye), in den Park (parka), in die Galerie (galerive)\n2. zu + Dativ (...e doğru):\nBir kişinin yanına veya mekanın kendisine giderken kullanılır (her zaman Dativ!):\n* zum Arzt (doktora), zum Bahnhof (istasyona), zur Schule (okula)\n3. nach (Şehir ve Ülkelere):\nArtikel almayan şehir ve ülkelere seyahatte kullanılır:\n* nach Berlin (Berlin'e), nach Deutschland (Almanya'ya)\n* Özel durum: nach Hause (eve)\n4. an ... vorbei (Yanından geçip gitmek + Dativ):\nBir yere uğramadan teğet geçmek için:\n* an der Universität vorbei (üniversitenin yanından geçerek)\nKural özeti: Şehir/ülke → nach | Kişi/mekan → zu | İçine giriş → in + Akkusativ" },
          { id: "dativ-akkusativ-edatlar", title: "Dativ ve Akkusativ Alan Edatlar", content: "Almancada bazı edatlar her zaman belirli bir hali alırken, \"iki yüzlü\" edatlar denen bir grup her iki hali de alabilir.\nHer Zaman Akkusativ Alan Edatlar:\n* durch (içinden geçerek), für (için), gegen (karşı), ohne (olmadan), um (etrafında/saat için)\n* Ich gehe durch den Park. (Parka içinden geçiyorum.)\n* Das ist ein Geschenk für dich. (Bu senin için bir hediye.)\nHer Zaman Dativ Alan Edatlar:\n* aus, bei, mit, nach, seit, von, zu, gegenüber\n* Ich fahre mit dem Bus. (Otobüsle gidiyorum.)\n* Er wohnt bei seiner Mutter. (Annesinin yanında oturuyor.)\nİki Yüzlü Edatlar (Wo → Dativ / Wohin → Akkusativ):\nin, auf, an, über, unter, vor, hinter, neben, zwischen\n* Wo? (Nerede — Dativ): Das Buch liegt auf dem Tisch.\n* Wohin? (Nereye — Akkusativ): Ich lege das Buch auf den Tisch.\nPüf noktası: Hareketsizlik = Dativ, Harekete yönelim = Akkusativ" },
        ]
      }
    ]
  },
